...
int main(int argc, char **argv) {
    ...
    // Device (GPU) memory — allocated with hipMalloc. These pointers are only
    ...
    // hipMemcpy blocks until the transfer completes, so wall-clock timing is
    // accurate here.
    ...
    print_stats("HIP GPU", n, num_runs, times);
